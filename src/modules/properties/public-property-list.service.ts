...
function databaseIsUnavailable(error: unknown) { return typeof error === "object" && error !== null && "code" in error && error.code === "P1001"; }

export async function listPublicProperties(query: PropertyQuery): Promise<{ items: PublicProperty[]; source: "database" | "development-fallback" }> {
