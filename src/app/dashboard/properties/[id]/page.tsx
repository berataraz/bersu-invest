...
export default async function PropertyEditPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PropertyEditor property={serializable} types={types} agents={agents} />;
}
