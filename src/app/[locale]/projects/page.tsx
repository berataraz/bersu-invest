...
export default async function ProjectsPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return <><PageHero eyebrow="Bersu Invest" title={t("projectsTitle")} description={t("projectsDescription")} image={siteImages.villa} /><section className="mx-auto max-w-[1440px] px-5 py-12 sm:px-8 lg:px-12"><ReviewQueueEmptyState locale={locale} /></section></>;
}
